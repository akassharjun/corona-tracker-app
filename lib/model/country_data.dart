...
List<CountryData> countryDataFromJson(String str) =>
    List<CountryData>.from(json.decode(str).map((x) => CountryData.fromMap(x)));
...
class CountryData {
  ...
  get countryCode {
    Map<String, String> countryCode = countryCodesList
        .firstWhere((Map<String, String> val) => val["name"].toLowerCase().replaceAll(' ', '') == country.toLowerCase().replaceAll(' ', ''));
